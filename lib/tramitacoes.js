...
// Etapas do funil de CS que não geram tramitação para o farmer. Medidas na
// conta, nos tickets reais:
...
//
// Concluído e Cancelado saem por estarem encerrados. Pagamento pós-palestra e
// Aguardando NF saem por outro motivo: ali o evento já aconteceu e o que falta
// é nota e pagamento — trabalho do CS, não do farmer.
export const ETAPAS_ENCERRADAS = [

...
const { CLOSERS, SEGMENTOS, PIPELINES_POR_SEG, SEG_CLOSER, segLideradoPor, EQUIPES_DE, closersDe, semEquipe } =
...
comTime("Farmer", "Cesar aprova closer do Farmer", () => podeGerirCloser(cesar, umDe("Farmer")));

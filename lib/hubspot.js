...
export async function getTicketsCS(pipelineId, etapasEncerradas = []) {
  const out = [];
  let after;
  do {
        ...
        filterGroups: [
          {
            filters: [
              ...
              // Ticket encerrado não gera tramitação.
              ...(etapasEncerradas.length
                ? [{ propertyName: "hs_pipeline_stage", operator: "NOT_IN", values: etapasEncerradas }]
                : []),
            ],
          },
        ],

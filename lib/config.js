...
export const CLOSERS = {
  B2B: [
    ...
    { id: "85002012", nome: "Bruna Machado" },
    // Vieram da guia Farmer em 22/09/2026, quando Farmer passou a ser o time
    // de CS. Sem equipe definida ainda (Dani ou Vince).
    { id: "94028856", nome: "Andrei Felippe Freitas de Mello" },
    { id: "81033487", nome: "Gustavo Stivanin Pacheco" },
    { id: "89632472", nome: "Maria Eduarda Porto Guimaraes" },
    { id: "79760745", nome: "Thiago Berto Souza" },
    { id: "96589066", nome: "Nathalia Pereira" },
    { id: "87159365", nome: "João Lucas Backmann" },
  ],
  // Time de CS. ponytail: vazio até os ownerIds serem confirmados no HubSpot.
  Farmer: [],
  B2C: [

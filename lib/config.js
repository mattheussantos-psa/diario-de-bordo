...
export const CLOSERS = {
  ...
  // Equipes (Katyeli, Camila, Leticia) ainda não distribuídas.
  Farmer: [
    { id: "93599591", nome: "Bruna Halfen Saraiva" },
    { id: "93238814", nome: "Francielle Sotoriva Inacio" },
    { id: "85846971", nome: "Francielle Teles Lenz" },
    { id: "95415669", nome: "Gisele Beatriz Santos dos Santos" },
    { id: "95993082", nome: "Hans Kelton Sales Lopes" },
    { id: "80228367", nome: "Jhuly Correa de Carvalho" },
    { id: "97204561", nome: "Juliano Machado Marques" },
    { id: "80454582", nome: "Katyeli Ceroni Madril" },
    { id: "97763591", nome: "Leonardo Bitencourt Machado" },
    { id: "88200239", nome: "Luiza Teixeira Basteiro Rodriguez" },
    { id: "94316537", nome: "Maria Julia Heredia Beck de Azevedo" },
    { id: "80688884", nome: "Rafael Rodrigues Brack da Silva" },
    { id: "92335488", nome: "Thaina Malta" },
    { id: "98715090", nome: "Vitor França Martini" },
  ],
  B2C: [
...
// O valor pode ser um segmento ou uma lista deles: o Cesar aprova o B2B e
// também o Farmer, que atua no mesmo funil.
export const LIDERES = {
  "eduardo.vince@profissionaissa.com": "B2B",
  "cesar.filho@profissionaissa.com": ["B2B", "Farmer"],
